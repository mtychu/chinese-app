testWords = [
   ...
   },
   {
      ...
      chineseTrad: "了",
      chineseSimp: "了",
      meanings: "(modal particle intensifying preceding clause), (completed action marker), to know, to understand, to know, clear, look afar from a high place",
   ...
   },
   {
      ...
      chineseTrad: "這",
      chineseSimp: "这",
      meanings: "this, these, this, these, (sometimes used before a measure word, especially in Beijing)",
   ...
   },
   {
      ...
      chineseTrad: "中",
      chineseSimp: "中",
      meanings: "within, among, in, middle, center, while (doing sth), during, China, Chinese, hit (the mark)",
